...
namespace vyermHW3_countoper
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Result 3: 15 + -4 * 6 / 11 = {0}", 15 + -4 * 6 / 11);
            // divide 10 by 6 is one (even number only), multiply by one > remains 1. Then 7 % 2 is one (remainder after division). 2 + 1 - 1 = 2.
            Console.WriteLine("Result 4: 2 + 10 / 6 * 1 - 7 % 2 = {0}", 2 + 10 / 6 * 1 - 7 % 2); 
            Console.ReadKey();
        }
    }
}
